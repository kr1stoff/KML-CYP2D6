...
/home/mengxf/miniforge3/envs/python3.12/bin/python \
    /data/mengxf/Project/KML250707-cyp2d6-igtk/work/250707-3samples-anlysis/scripts/process_aldy.py \
    $OUTDIR/$NAME.aldy.txt \
    $OUTDIR/$NAME.genotype.xlsx
/home/mengxf/miniforge3/envs/basic/bin/csvtk xlsx2csv -t -n Sheet $OUTDIR/$NAME.genotype.xlsx >$OUTDIR/$NAME.genotype.txt
